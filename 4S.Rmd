...
As $v \to \infty$ the equation $\pi\bm{P}(v)=\pi$ is true [@doi:10.1093/acprof:oso/9780199602605.001.0001].
...
The factor $\mu$ rescales the matrix that the mean substitution rate is one. It can be calculated as follows: [@Huelsenbeck]
...
Since we're only given one distance, we assume an unrooted tree where the mouse sequence is ancestral to the human sequence.  
...
$$Pr_{AA}(v, \kappa, \pi)=\pi_{A}*p_{AA}(v)=`r formatC(pi_A, digits=3, format="f")`*`r formatC(transition_matrix_0_01["A","A"], digits=3, format="f")`=`r formatC(pi_A*transition_matrix_0_01["A","A"], digits=3, format="f")`$$
$$Pr_{TT}(v, \kappa, \pi)=\pi_{T}*p_{TT}(v)=`r formatC(pi_T, digits=3, format="f")`*`r formatC(transition_matrix_0_01["T","T"], digits=3, format="f")`=`r formatC(pi_T*transition_matrix_0_01["T","T"], digits=3, format="f")`$$
$$Pr_{GG}(v, \kappa, \pi)=\pi_{G}*p_{GG}(v)=`r formatC(pi_G, digits=3, format="f")`*`r formatC(transition_matrix_0_01["G","G"], digits=3, format="f")`=`r formatC(pi_G*transition_matrix_0_01["G","G"], digits=3, format="f")`$$
$$Pr_{AA}(v, \kappa, \pi)=\pi_{A}*p_{AA}(v)=`r formatC(pi_A, digits=3, format="f")`*`r formatC(transition_matrix_0_01["A","A"], digits=3, format="f")`=`r formatC(pi_A*transition_matrix_0_01["A","A"], digits=3, format="f")`$$
$$Pr_{CC}(v, \kappa, \pi)=\pi_{C}*p_{CC}(v)=`r formatC(pi_C, digits=3, format="f")`*`r formatC(transition_matrix_0_01["C","C"], digits=3, format = "f")`=`r formatC(pi_C*transition_matrix_0_01["C","C"], digits=3, format="f")`$$
$$Pr_{AC}(v, \kappa, \pi)=\pi_{A}*p_{AC}(v)=`r formatC(pi_A, digits=3, format="f")`*`r formatC(transition_matrix_0_01["A","C"], digits=3, format="f")`=`r formatC(pi_A*transition_matrix_0_01["A","C"], digits=3, format="f")`$$
$$Pr_{AC}(v, \kappa, \pi)=\pi_{A}*p_{AC}(v)=`r formatC(pi_A, digits=3, format="f")`*`r formatC(transition_matrix_0_01["A","C"], digits=3, format="f")`=`r formatC(pi_A*transition_matrix_0_01["A","C"], digits=3, format="f")`$$
$$Pr_{AC}(v, \kappa, \pi)=\pi_{A}*p_{AC}(v)=`r formatC(pi_A, digits=3, format="f")`*`r formatC(transition_matrix_0_01["A","C"], digits=3, format="f")`=`r formatC(pi_A*transition_matrix_0_01["A","C"], digits=3, format="f")`$$
$$Pr_{CA}(v, \kappa, \pi)=\pi_{C}*p_{CA}(v)=`r formatC(pi_C, digits=3, format="f")`*`r formatC(transition_matrix_0_01["C","A"], digits=3, format="f")`=`r formatC(pi_C*transition_matrix_0_01["C","A"], digits=3, format="f")`$$
$$Pr_{AA}(v, \kappa, \pi)=\pi_{A}*p_{AA}(v)=`r formatC(pi_A, digits=3, format="f")`*`r formatC(transition_matrix_0_01["A","A"], digits=3, format="f")`=`r formatC(pi_A*transition_matrix_0_01["A","A"], digits=3, format="f")`$$
...
maximum log-likelihood (Figure \ref{fig:maximum-likelihood}) around $\hat{\kappa}$ 
we estimated.
...
The estimate of $\hat{\kappa} = `r formatC(kappa_hat, digits = 3, format = "f")`$ 
is very close to the maximum but there is a transition transversion rate ratio which 
gives a slightly better likelihood:
...
it is assumed that the substitutions happen independantly across sites.  
