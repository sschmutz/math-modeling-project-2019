...
The aim of this work is to generate a Markov model of a nucleotide sequence which 
consideres different substitution rates for transitions and transversions.  
The four nucleotides of DNA represent the four different states of the Markov model.  
Other parameters needed for the model are the initial state distribution and 
...
This model then allows us to calculate the probability of a given sequence.
**?not sure if this is the goal, specify the correct goal?**
...
**?These are the initial state distribution probabilities or equilibrium distribution \pi?**
