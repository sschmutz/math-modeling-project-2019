...
nt_comparisons <-
  ...
  mutate(frequency = count / alignment_length,
         mouse = fct_relevel(mouse, nt_order),
...
K80_ml_list <- optim(c("v" = 0.1, "kappa" = 35), neg_l_K80)
...
F81_ml_list <- optim(c("v" = 0.1, "pi_T" = 1/4, "pi_C" = 1/4, "pi_A" = 1/4), neg_l_F81)
...
HKY85_ml_list <- optim(c("v" = 0.1, "kappa" = kappa_hat, "pi_T" = 1/4, "pi_C" = 1/4, "pi_A" = 1/4), neg_l_HKY85)
