...
The evolutionary distance given ($v = 0.01$) is much lower compared to the estimated distance $\hat{v}$ based on the K80 model [@Kimura1980]:

$$\hat{v} = -\frac{1}{2}\ln(1-2S-V)-\frac{1}{4}\ln(1-2V) = `r round(v_hat_K80, digits = 3)`$$
