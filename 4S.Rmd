...
```{r maximum-likelihood, echo=FALSE, warning=FALSE, fig.width=3, fig.height=3, fig.align="center", fig.cap="Log-likelihood curve of the proposed model", fig.pos = "H"}
...
alignments <- 10000
length <- length(mt_cyb$HOMOSAPIENSCYTB)
...
```{r simulation-plot, echo=FALSE, message=FALSE, fig.width=3, fig.height=3, fig.align="center", fig.cap="Log-likelihood distribution of simulated sequences", fig.pos = "H"}
...
```{r simulation-table, echo=FALSE, warning=FALSE}
# simulations %>%
#   group_by(mouse) %>%
#   summarise(n = n())
# 
...
$$\hat{v} = -\frac{1}{2}\ln(1-2S-V)-\frac{1}{4}\ln(1-2V) = `r round(d_hat, digits = 4)`$$
