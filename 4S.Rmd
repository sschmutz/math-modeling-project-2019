...
The estimate of transition transversion rate ratio ($\kappa$) can be calculated as follows:  
$$\kappa = \frac{2ln(1-2S-V)}{ln(1-2V)}-1 = `r round(kappa_hat, digits = 4)`$$ [@doi:10.1093/acprof:oso/9780199602605.001.0001]
